...
<aside class="aside flex com_h-pageTop overflow-hidden" style="width: 500px;">
  <?php if( is_user_logged_in() ) {?>
  <!-- サブメニュー 左サイドバーの場合はout_lにorder-2を入れる。右サイドバーの場合は削除 -->
  <div class="out_l com_bg-submenu order-2 overflow-y-auto" style="width: 13rem">
  ...
  <div class="out_r com_bg-sidebar order-1 overflow-y-auto" style="width: 15rem">
      ...
      <div class="inner pt-2 pl-4 pb-12">
        <ul class="text-sm">
          <li v-for="n in restCatData" :key="n.id" class="pb-4">
            <span class="inline-block pb-3 text-xl font-bold com_font-anton">{{ n.name }}</span>
